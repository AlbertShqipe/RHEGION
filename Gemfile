...
# Use the latest version of Bootstrap for Sass
gem "bootstrap", "~> 5.2"

# Use the latest version of Autoprefixer for Rails
gem "autoprefixer-rails"

# Use the latest version of Font Awesome for Sass
gem "font-awesome-sass", "~> 6.1"

# Use the latest version of Simple Form
gem "simple_form"
